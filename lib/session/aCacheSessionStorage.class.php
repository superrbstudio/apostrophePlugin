...
/**
 * This is a copy of Dustin Whittle's standard sfCacheSessionStorage with two bug fixes:
 * the set and get calls on the cache object need to be serialized properly to store the
 * data array with all cache classes, and the code has been tweaked to support the 
 * standard name for the httponly option as well as dwhittle's http_only variation so that
 * people relying on either do not have a nasty surprise. This class will probably become
 * an empty subclass when these bugs are fixed upstream. Thanks to dwhittle for
 * confirming the serialize bug
 */
class aCacheSessionStorage extends sfSessionStorage
{
  protected
    $id          = null,
    $context     = null,
