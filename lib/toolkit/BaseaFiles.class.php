...
class BaseaFiles
{
  ...
  /**
   * These are provided as override points. Apostrophe calls these
   * rather than calling unlink and rmdir directly so that debugging
   * hooks and/or a trashcan folder can be optionally implemented
   */
