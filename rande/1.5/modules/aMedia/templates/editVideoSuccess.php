...
<div class="a-media-library">
  ...
  <div class="a-media-items a-media-edit-video">				
	  <?php include_partial('aMedia/edit', array('item' => $item, 'form' => $form, 'popularTags' => $popularTags, 'allTags' => $allTags, 'formAction' => url_for('@a_media_other?action=editVideo'), 'editVideoSuccess' => true)) ?>
  </div>
