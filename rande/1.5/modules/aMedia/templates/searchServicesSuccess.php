...
<div class="a-media-library">
	...
	<div class="a-ui a-media-select a-search clearfix">
	  ...
	  <form method="POST" action="<?php echo url_for('@a_media_other?action=searchServices') ?>" class="a-search-form a-media-search-services a-media-services-form a-ui" id="a-media-search-services">
