...
<?php if ($mediaItem->userHasPrivilege('edit')): ?>
    ...
    <li><?php echo link_to('<span class="icon"></span>'.a_("Edit"), "aMedia/edit", array("query_string" => http_build_query(array("slug" => $mediaItem->getSlug())), "class" => "a-btn icon a-edit lite alt")) ?></li>
