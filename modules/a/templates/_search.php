...
<div id="a-search">
  <form id="a-search-global" action="<?php echo url_for('a/search') ?>" method="get" class="a-search-form">
    <div><label for="q" style="display:none;">Search</label><input type="text" name="q" value="<?php echo htmlspecialchars($sf_params->get('q')) ?>" class="a-search-field" id="a-search-cms-field"/></div>
