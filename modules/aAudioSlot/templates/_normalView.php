...
<?php slot("a-slot-controls-$pageid-$name-$permid") ?>
	<li class="a-controls-item choose-audio">
	  <?php include_partial('aImageSlot/choose', array('action' => 'aAudioSlot/edit', 'buttonLabel' => a_get_option($options, 'button-label', a_('Choose Audio File')), 'label' => a_get_option($options, 'browse-label', a_('Select an Audio File')), 'class' => 'a-btn icon a-audio', 'type' => 'audio', 'itemId' => $itemId, 'name' => $name, 'slug' => $slug, 'permid' => $permid)) ?>
	</li>
