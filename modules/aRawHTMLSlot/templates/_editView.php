...
<ul class="a-raw-html-info">
	<li>
		...
		<?php else: ?>
	  	<?php echo __('Use this slot to add raw HTML markup, such as embed codes.') ?>
		<?php endif ?>
	</li>
	<li>
		<?php echo __('Use this slot with caution. If bad markup causes the page to become uneditable, add ?safemode=1 to the URL and edit the slot to correct the markup.') ?>
	</li>
</ul>
