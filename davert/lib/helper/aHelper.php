...
if (!sfContext::getInstance()->getUser()->isAuthenticated() && sfConfig::get('app_a_minify',false))  {
  
    sfContext::getInstance()->getConfiguration()->loadHelpers(array("aMinify"));

} elseif (sfContext::getInstance()->getUser()->getAttribute('a_minify_mode',false)) {
